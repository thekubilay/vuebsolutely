<template>
  <div class="images-container flex">
    ...
    <div class="image-content flex-column">
      ...
      <!-- <div v-if="checkArray" class="image-scroll"> -->
      <div class="image-barscroll overflow-x flex ">
        <div class="image" 
...
export default {
  ...
  setup(props, {emit}) {
    ...
    const styles = reactive({
      ...
      // backgroundImage : (props.image)&&typeof(props.image==='string')? 'url(../../assets/'+props.image+')': false,
      //not necessary, but failsafe if no image found
      backgroundColor : "#444444", 
    })

    // const getAddress = (img)=>{
    //   return `url("../../assets/${img}")`
    // }

    const ckeckArray = computed(() => {
